...
namespace rsx
{
	...
	private:
		...
		struct transport_packet
		{
			...
			transport_packet(op packet_type, u32 address, u32 data)
				: type(packet_type), aux_param0(address), aux_param1(data)
			{
				ensure(packet_type == op::gcm_label_write);
			}
	...
	public:
		...
		bool try_enqueue_ordered_gcm_label_write(u32 address, u32 data) const;
